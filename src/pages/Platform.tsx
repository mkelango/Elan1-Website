  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Every brand name inherits it. capability + “1” = the number-one, hyper-personalized, unified, agentic version of it. customer1, finance1, health1 — each is the best, most personal, most unified version of its function or field."
      ...
      <Section tone="obsidian">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="display mt-6 text-2xl leading-snug text-paper sm:text-3xl">
            Lowercase, one word + “1”, no space. <span className="font-mono text-clay">customer1</span> — never “Customer 1”.
            Only functions, products, and verticals get a “1” name. The master brand endorses its family: “customer1, an elan1 company.”
          </p>
        </div>
      </Section>
