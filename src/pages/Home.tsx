          ...
          <div className="relative">
            <div className="overflow-hidden rounded-card border border-lineDark bg-obsidian shadow-lift">
              <div className="flex items-center gap-2 border-b border-lineDark px-4 py-3">
                ...
                <span className="ml-2 font-mono text-[11px] text-paper/50">agent · customer1 · live</span>
                <Link
                  to="/demo"
    ...
    <Section tone="paper">
      <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
        <SectionHead
          ...
          lede="Seven agentic apps, each owning one function, each reusable across every industry — unified on the enterprise1 backbone."
        />
        <Reveal delay={0.1}>
