        ...
        <div>
          ...
          <Reveal delay={0.06}>
            <h1 className="display mt-6 text-4xl text-ink sm:text-5xl lg:text-[3.9rem]">
              ...
              <span className="relative whitespace-nowrap text-clayDeep">Every decision signed.
          ...
          <Reveal delay={0.12}>
            <p className="lede mt-7 max-w-xl">
              Your system of record is where your agents write. So the audit isn't a log saying we
              called an API. It's the policy that fired, the person who approved it, and every record change. Governance by design.
            </p>
          </Reveal>
          <Reveal delay={0.18}>
