...
export const solutions: Solution[] = [
...

  {
    ...
    composedOf: ["finance1", "customer1", "assure1"],
    accent: ACCENT.clay,
    useCases: [
    ...
    seo: {
      ...
      description:
        "bank1 accelerates research, underwriting, and compliance on verified data with audit trails and model-risk governance. Composes finance1, customer1, and assure1.",
    },
  },
...

  {
    ...
    composedOf: ["supply1", "customer1", "market1"],
    accent: ACCENT.gold,
    useCases: [
      ...
      { title: "Returns & local SEO", description: "Triages RMAs and produces local SEO content." },
    ],
    compliance:
    ...
    seo: {
      ...
      description:
        "retail1 turns catalog, demand, and customer ops agentic — more conversion, fewer stockouts, lower support cost. Composes supply1, customer1, and market1.",
    },
  },
