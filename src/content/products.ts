...
export const products: Product[] = [
...

  {
    ...
    hero: {
      ...
      subhead:
        "Shared governance, identity, data, skills, observability across every function, rolled out in waves.",
      primaryCta: "Talk to sales",
    },
    problem: [
      "Point agents sprawl without governance.",
      "Identity, access, audit inconsistent across tools.",
      "No single place to observe agents.",
      "Scaling pilot to enterprise stalls.",
    ],
    capabilities: [
      { title: "Unified governance", description: "One policy, audit, human-in-loop across agents." },
      { title: "Identity & access", description: "SSO and least-privilege across functions." },
      { title: "Shared skills & connectors", description: "Reusable Skills and MCP connectors." },
      { title: "Observability & control", description: "Single pane to monitor and manage agents." },
      { title: "Wave rollout", description: "Staged adoption model function by function." },
    ],
    outcomes: [
      "One governance, one audit chain across suite",
      "New app inherits identity and audit posture",
      "Staged agent enablement with suspend switch",
      "One control plane for enterprise",
    ],
    integrations: ["Identity providers", "Enterprise data sources", "Full suite", "MCP connectors"],
    suiteFit:
      "The backbone every product standardizes on.",
    trust:
      "Governance, audit, human-in-the-loop are first-class primitives.",
    pricingTiers: [
