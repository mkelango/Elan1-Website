...
export const initiatives: Initiative[] = [
  ...
  },
  {
    ...
    approach: [
      ...
      { title: "Sell with context", description: "sales1 researches accounts and drafts personalized, on-brand outreach grounded in your data." },
    ...
    seo: {
      ...
      description: "Agentic CX that resolves, personalizes, and grows — composing service1, sales1, and market1 with human-in-the-loop.",
    },
  },
  {
    slug: "cost-finops",
