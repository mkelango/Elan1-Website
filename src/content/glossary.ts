...
export const GLOSSARY: Term[] = [
  ...
  },
  {
    ...
    category: "The idea",
    usage: "elan1",
    def: "The declared level an agent runs at: autonomous (log, enrich, note), one-tap (a lightweight human confirm), or human-led (a person decides). Read this precisely — the tier is declarative metadata, and what gates an action is the spec's requires-approval flag plus the policy evaluation. Raising a tier does not open a consequential action: in insight1, publishing stays human-approved at every level. Where a tenant opts into graduated autonomy, a small in-tolerance action proceeds without a gate, anything above tolerance or over the per-period budget escalates to a human, and a value above a hard ceiling is refused outright; an unconfigured action class stays human-approved. An agent cannot widen its own envelope.",
