...
export const GLOSSARY: Term[] = [
  ...
  // ——— Working with us ————————————————————————————————————————————————————————————————————————
  {
    ...
    usage: "elan1",
    def: "Fixed-scope planning engagement producing current-state map, candidate workflows, wave order. Value model from your assumptions, labelled illustrative.",
    why: "Leaves document set and rollout order, not running system. Unanswered list written, not implied closed.",
  ...
  },
  {
    ...
    category: "Working with us",
    usage: "elan1",
    def: "Fixed-scope engagement taking one vertical workflow live and governance-validated: typed blueprint, evaluated before run, routed to human at consequential steps, metered, audited.",
    why: "Mark eval-gated; withheld until evidence passes; timeline depends on workflow.",
  ...
  },
  {
    ...
    category: "Working with us",
    usage: "elan1",
    def: "Three revenue bands (Growth, Scale-up, Enterprise) describing which apps/packs/retainers fit, not price.",
    why: "Estimator holds no automation-rate default; agent share is your assumption.",
  ...
  },
  {
    ...
    category: "Working with us",
    usage: "elan1",
    def: "Training/certification surface: role-based programmes, credentialed paths, adoption enablement. People learn here, not software runs. No bench; directory lists consenting practitioners only.",
    why: "Credential is not permission; admin grants role, not course.",
  ...
  },
  {
    ...
    usage: "elan1",
    aka: ["X4"],
    def: "Governed subset for partners: apps, packs, connectors as typed manifests, tested, certified, least-privileged, audited on same fabric.",
