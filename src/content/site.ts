...
> = {
  ...
  products: {
    label: "Products",
    tag: "What we deploy",
    blurb: "The 1 Suite — seven agentic apps, one for every business function, unified on enterprise1.",
    accent: "#2f6df0",
    href: "/products",
  },
  solutions: {
...
export const NAV: NavItem[] = [
  {
    ...
    mega: [
      {
        ...
        links: [
          { label: "customer1", href: "/products/customer1", desc: "Sales & CRM", tag: "live", accent: "#df8c64" },
    ...
    featured: {
      ...
      body: "Seven agentic apps, one control plane. Explore how they compose into a single agentic enterprise.",
      href: "/products",
