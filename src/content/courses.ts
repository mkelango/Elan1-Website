...
export const COURSES: Course[] = [
  ...
  { slug: "run-sales1", title: "Run sales1", role: "sales", level: "Associate", summary: "Operate the sales app: account research, grounded outreach, human-approved commitments.", modules: ["Account research", "Grounded outreach", "Approvals"], accent: "#df8c64" },
];
