...
import { NAV, REGIONS, type NavItem } from "../content/site";
    ...
    >
      <div className="shell relative flex h-16 items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <a href="http://localhost:5189" className="hidden text-sm font-medium text-ink/70 hover:text-ink sm:inline-flex sm:px-3 sm:py-2">
            Log in
          </a>
          ...
          >
            <div className="shell max-h-[75vh] space-y-1 overflow-y-auto py-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <a href="http://localhost:5189" className="btn-ghost flex-1 text-center">Log in</a>
              </div>
            </div>
          </motion.div>
        )}
